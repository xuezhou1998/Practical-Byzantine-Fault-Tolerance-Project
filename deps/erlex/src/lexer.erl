-file("/usr/local/Cellar/erlang/24.1.4/lib/erlang/lib/parsetools-2.3.1/include/leexinc.hrl", 0).
...
-file("/usr/local/Cellar/erlang/24.1.4/lib/erlang/lib/parsetools-2.3.1/include/leexinc.hrl", 14).
...
yystate(41, [124|Ics], Line, Tlen, Action, Alen) ->
...
yystate(41, [40|Ics], Line, Tlen, Action, Alen) ->
...
yystate(41, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(43, Ics, Line, Tlen+1, Action, Alen);
yystate(41, [C|Ics], Line, Tlen, Action, Alen) when C >= 36, C =< 38 ->
    yystate(43, Ics, Line, Tlen+1, Action, Alen);
...
yystate(41, [C|Ics], Line, Tlen, Action, Alen) when C >= 63, C =< 90 ->
    yystate(43, Ics, Line, Tlen+1, Action, Alen);
yystate(41, [C|Ics], Line, Tlen, Action, Alen) when C >= 96, C =< 101 ->
    yystate(43, Ics, Line, Tlen+1, Action, Alen);
yystate(41, [C|Ics], Line, Tlen, Action, Alen) when C >= 103, C =< 122 ->
    yystate(43, Ics, Line, Tlen+1, Action, Alen);
...
yystate(39, [10|Ics], Line, Tlen, _, _) ->
    yystate(39, Ics, Line+1, Tlen+1, 0, Tlen);
...
yystate(36, [46|Ics], Line, Tlen, _, _) ->
    yystate(32, Ics, Line, Tlen+1, 29, Tlen);
...
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 40 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
...
-file("/usr/local/Cellar/erlang/24.1.4/lib/erlang/lib/parsetools-2.3.1/include/leexinc.hrl", 313).
